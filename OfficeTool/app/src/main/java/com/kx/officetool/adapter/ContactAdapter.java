package com.kx.officetool.adapter;
...
public class ContactAdapter extends ArrayAdapter<User> implements
	...
	public ContactAdapter(Context context, int layoutResource, List<User> objects) {
        ...
        avatarLoader = LoadUserAvatar.getInstance(context);
    }
    ...
    private void showUserAvatar(ImageView iamgeView, String avatar) {
        ...
        final String url_avatar = "http://upload.jianshu.io/users/upload_avatars/19107/08f8146dae87.jpg?imageMogr2/auto-orient/strip|imageView2/1/w/240/h/240";
//        final String url_avatar = Constant.URL_Avatar + avatar;
        ...
        if (url_avatar != null && !url_avatar.equals("")) {
            ...
            else iamgeView.setImageResource(R.mipmap.ic_personal_default);
