    ...
    public static int getOrientation(byte[] jpeg) {
        ...
        if (length > 8) {
            ...
            if (tag != 0x49492A00 && tag != 0x4D4D002A) {
            	LogUtil.e(TAG, "Invalid byte order");
                return 0;
            }
            boolean littleEndian = (tag == 0x49492A00);

            // Get the offset and check if it is reasonabxiale.
            int count = pack(jpeg, offset + 4, 4, littleEndian) + 2;
            if (count < 10 || count > length) {
            	LogUtil.e(TAG, "Invalid offset");
                return 0;
            }
            offset += count;
            length -= count;
            ...
            while (count-- > 0 && length >= 12) {
                ...
                if (tag == 0x0112) {
                    ...
                    LogUtil.v(TAG, "Unsupported orientation");
                    return 0;
                }
                offset += 12;
                length -= 12;
        ...
        LogUtil.v(TAG, "Orientation not found");
        return 0;
    }
