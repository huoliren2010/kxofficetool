...
//        Glide.with(this).load(companyInfo.getCompanAvatarUrl()).diskCacheStrategy(DiskCacheStrategy.ALL).placeholder(R.mipmap.ic_personal_default).error(R.mipmap.ic_personal_default).into(mIvCompanyAvatar);
    ...
    private void loadUserInfo() {
        ...
        if(mCompanyInfo != null){
            ...
            mList.add(new UserInfo().setUserAvatar("http://imgsrc.baidu.com/forum/w%3D580/sign=22e7d635bd8f8c54e3d3c5270a2b2dee/3f10b3de9c82d1584109496a890a19d8bd3e427f.jpg").setUserGender(UserInfo.GENDER.BOY).setUserName("陈海").setPhoneNumber("114").setCompanyId(mCompanyInfo.getCompanyId()).setLevel(UserInfo.Level.NORMAL));
            mList.add(new UserInfo().setUserAvatar("http://imgsrc.baidu.com/forum/w%3D580/sign=9017ac60af1ea8d38a22740ca70830cf/54b8cd11728b47101affe617cacec3fdfd032336.jpg").setUserGender(UserInfo.GENDER.BOY).setUserName("沙瑞金").setPhoneNumber("114").setCompanyId(mCompanyInfo.getCompanyId()).setLevel(UserInfo.Level.NORMAL));
            mList.add(new UserInfo().setUserAvatar("http://imgsrc.baidu.com/forum/w%3D580/sign=a86449cc6bd0f703e6b295d438fb5148/9c170cf3d7ca7bcb2831d8f4b7096b63f724a8b8.jpg").setUserGender(UserInfo.GENDER.BOY).setUserName("丁义珍").setPhoneNumber("114").setCompanyId(mCompanyInfo.getCompanyId()).setLevel(UserInfo.Level.NORMAL));
            mList.add(new UserInfo().setUserAvatar("http://imgsrc.baidu.com/forum/w%3D580/sign=3340a1bf9deef01f4d1418cdd0fc99e0/729bd158ccbf6c8107c53433b53eb13532fa4010.jpg").setUserGender(UserInfo.GENDER.BOY).setUserName("祁同伟").setPhoneNumber("114").setCompanyId(mCompanyInfo.getCompanyId()).setLevel(UserInfo.Level.MIDDLE));
            mList.add(new UserInfo().setUserAvatar("http://imgsrc.baidu.com/forum/w%3D580/sign=b819870701fa513d51aa6cd60d6c554c/e45ff21fbe096b63dfb24c8b05338744eaf8ac5f.jpg").setUserGender(UserInfo.GENDER.BOY).setUserName("季昌明").setPhoneNumber("114").setCompanyId(mCompanyInfo.getCompanyId()).setLevel(UserInfo.Level.ADVANCED));
            mList.add(new UserInfo().setUserAvatar("http://imgsrc.baidu.com/forum/w%3D580/sign=2807a73fba1c8701d6b6b2ee177e9e6e/8cc0f2d3572c11dfaf98a6f86a2762d0f603c2bd.jpg").setUserGender(UserInfo.GENDER.BOY).setUserName("高育良").setPhoneNumber("114").setCompanyId(mCompanyInfo.getCompanyId()).setLevel(UserInfo.Level.ADVANCED));
            mList.add(new UserInfo().setUserAvatar("http://www.people.com.cn/mediafile/pic/20170409/63/16943124615050023627.jpg").setUserGender(UserInfo.GENDER.BOY).setUserName("侯亮平").setPhoneNumber("114").setCompanyId(mCompanyInfo.getCompanyId()).setLevel(UserInfo.Level.ADVANCED));
            mList.add(new UserInfo().setUserAvatar("http://imgsrc.baidu.com/forum/w%3D580/sign=5671fd63dd3f8794d3ff4826e21a0ead/dbe3e6cd7b899e51cb8724cf4ba7d933c9950dfd.jpg").setUserGender(UserInfo.GENDER.BOY).setUserName("李达康书记").setPhoneNumber("114").setCompanyId(mCompanyInfo.getCompanyId()).setLevel(UserInfo.Level.BOSS));
